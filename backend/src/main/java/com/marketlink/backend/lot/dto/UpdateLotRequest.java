...
@AllArgsConstructor
@Builder
@Schema(description = "Request payload for updating draft lot details")
public class UpdateLotRequest {

    @Schema(description = "UUID of the master crop", example = "a1b2c3d4-e5f6-7890-abcd-ef1234567890")
    private UUID cropId;
    ...
    @Schema(description = "Quantity of produce in the lot", example = "600.0")
    ...
    @Schema(description = "Farmer's target/expected price per unit", example = "38.0")
    private Double expectedPrice;

    @Positive(message = "Minimum acceptable price must be strictly greater than 0")
    @Schema(description = "Minimum floor price per unit acceptable to farmer", example = "32.0")
